sap.ui.define([
		...
		return BaseObject.extend("supportsolutionscust.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias supportsolutionscust.model.ListSelector
			 */
			 ...
			 * @return {supportsolutionscust.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
