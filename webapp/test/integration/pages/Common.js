sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("supportsolutionscust/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("supportsolutionscust.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["supportsolutionscust/localService/mockserver"], function (mockserver) {
